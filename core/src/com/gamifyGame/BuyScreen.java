...
public abstract class BuyScreen extends GamifyScreen
{
    ...
    public void render(float delta)
    {
        ...
        if(selectedBuyable !=null)
            movingTextDisplayBox.addText(new Point(0, 30), selectedBuyable.toString(), GamifyTextSize.SMALL);
        movingTextDisplayBox.addText(new Point(0, -15),"Vitality "+game.getVitality(), GamifyTextSize.SMALL);
